...
OPENAI_EMBEDDING_MODEL_DIMENSIONS = int(os.getenv("OPENAI_EMBEDDING_MODEL_DIMENSIONS", "768"))
OPENAI_CHAT_MODEL = os.getenv("OPENAI_CHAT_MODEL", "gpt-4.1-mini-2025-04-14")

# Pinecone settings
PINECONE_API_KEY = os.getenv("PINECONE_API_KEY")
PINECONE_INDEX_NAME = os.getenv("PINECONE_INDEX_NAME", "basic-rag")
